...
file = open("composite_sqrt.txt","x")
file.write("train_accuracy_list_sqrt = {}\n".format(str(train_accuracy_list)))
file.write("test_accuracy_list_sqrt = {}\n".format(str(test_accuracy_list)))
file.write("lr_list_sqrt = {}\n".format(str(lr_list)))
file.write("statistic_list_sqrt = {}\n".format(str(statistic_list)))
file.write("key_list_sqrt = {}\n".format("array(" + str(key_list) + ")"))
file.write("avg_loss_list_sqrt = {}\n".format(str(avg_loss_list)))
file.write("total_time_sqrt = {}\n".format(str(end - start)))
file.close()
print("complete")
