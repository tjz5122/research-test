...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), mode = 'In loss plus smooth', var_mode='mb', tolerance = 0.01, minN_stats=100)
...
file = open("In_loss_plus_smooth.txt","x")
file.write("train_accuracy_list_ln = {}\n".format(str(train_accuracy_list)))
file.write("test_accuracy_list_ln = {}\n".format(str(test_accuracy_list)))
file.write("lr_list_ln = {}\n".format(str(lr_list)))
file.write("statistic_list_ln = {}\n".format(str(statistic_list)))
file.write("key_list_ln = {}\n".format("array(" + str(key_list) + ")"))
file.write("avg_loss_list_ln = {}\n".format(str(avg_loss_list)))
file.write("total_time_ln = {}\n".format(str(end - start)))
file.close()
print("complete")
