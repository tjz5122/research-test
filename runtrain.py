...
command = 'python main.py --cuda --net=mgnet --ch=256 --iter=2222 --data cifar10 --epochs=300 --lr {} -b {} -m=0.8 --wd {} --km loss_plus_smooth --vm mb --minstat=100 --sf=100 --tol=0.005 --sig=0.05 --trail {}'
# flexible
