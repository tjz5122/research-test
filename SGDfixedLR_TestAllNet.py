...
for my_model in modeldic:
    ...
    f.write("SGDfixedlr_"+ my_model +"_testacculist = {}".format(test_accuracy_list))
    f.write("SGDfixedlr_"+ my_model +"_lrlist = {}".format(lr_list))
    f.write("SGDfixedlr_"+ my_model +"_losslist = {}".format(avg_loss_list))
    f.write("SGDfixedlr_"+ my_model +"_time = {}".format(time))
    f.write("SGDfixedlr_"+ my_model +"_maxtestaccu = {}".format(max_test_accuarcy))
    f.write("SGDfixedlr_"+ my_model +"_peakepoch = {}".format(peak_epoch))
