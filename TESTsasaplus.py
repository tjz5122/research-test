...
optimizer = SASA(my_model.parameters(), lr=lr, weight_decay=wd, momentum=m, testfreq=testfreq, drop_factor=dropfactor, 
...
print("SASA+accu: ",test_accuracy_list)
print("\n")
print("SASA+lr: ",lr_list)
