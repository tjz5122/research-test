...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), var_mode='mb', mode='loss',tolerance = 0.005, minN_stats=100)
...
file = open("SSMpureResNet18.txt","x")
