# -*- coding: utf-8 -*-
"""
Created on Sun Mar  7 11:43:03 2021
...
class SSM(SSM_Optimizer):
    ...
    def __init__(self, params, lr=-1, momentum=0, weight_decay=0, 
        ...
        self.state['composite_test'] = True
    ...
    def stats_adaptation(self):
        ...
        if self.state['composite_test'] == True:
            self.state['mode'] = 'loss plus smooth'
        if self.state['composite_test'] == False:
...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), mode = 'log10 loss plus smooth', var_mode='mb', tolerance = 0.01, minN_stats=100)
...
file = open("composite_log10.txt","x")
