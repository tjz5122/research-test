...
test_param_groups["wd_group"] = [0.0001,0.0005,0.001] #SASA+: 0.0005
test_param_groups["trail_group"] = [1,2]
test_param_groups["drop_factor_group"] = [5,10]           #SASA+: 2,5,10
test_param_groups["batch_size_group"] = [128,256]
test_param_groups["epochs_group"] = [240]
test_param_groups["leaky_group"] = [4,8,12]                 #SASA+: 2,4,8,16
